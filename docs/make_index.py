...
sections = [
 ...
 ('Hand-authored geometry, never seen in training (work in progress)', 'Control videos drawn in the editor and rendered with the same renderer as the training data. With a photograph as background the camera must first be fitted to the photo (GeoCalib); without the fit the scale is wrong. Several cases below still show problems and are labelled as such.',
  [('Two Roman soldiers fight in the Colosseum (background: a Wikimedia Commons photo, CC BY-SA 2.0 daryl_mitchell, tourists patched out). Camera fitted to the photograph with GeoCalib (focal length + horizon), static.', S3 / 'control_roman_fit_static.mp4', S3 / 'roman_fit_static/00000003.mp4', S3 / 'colosseum_ref.png', 'roman_fit_static'),
   ('Fitted camera, orbit anchored to the photo pose. Partial: first frame at the right scale, the fighters grow towards the end.', S3 / 'control_roman_fit_orbit.mp4', S3 / 'roman_fit_orbit/00000003.mp4', None, 'roman_fit_orbit'),
   ...
   ('Same duel WITHOUT fitting the ground (default authoring camera). Failure: the fighters come out far larger than the cylinders prescribe. Static.', S3 / 'control_roman_static.mp4', S3 / 'roman_static/00000003.mp4', None, 'roman_static'),
   ('Default camera, orbit. Failure: wrong scale (too large, too close).', S3 / 'control_roman_orbit.mp4', S3 / 'roman_orbit/00000003.mp4', None, 'roman_orbit'),
   ('Default camera, dolly in. Failures: the fighters do not swap sides as the cylinders do, and the scale is wrong.', S3 / 'control_roman_dolly_in.mp4', S3 / 'roman_dolly_in/00000003.mp4', None, 'roman_dolly_in'),
...
<p class="links"><a href="https://drive.google.com/open?id=1_tsTy2CYDZT6kYTShU6yR7e60dMTnDCW">Paper (draft PDF, Google Drive)</a><a href="https://github.com/zshyang/CoaG">Code + editor</a><a href="https://huggingface.co/zshyang1106/CoaG-Wan2.2-Fun-A14B-Control-LoRA">LoRA weights</a><a href="https://drive.google.com/open?id=1yv-DrbCfJ_x8wmVsB9anHnuIjRzQENEB">Data (Google Drive)</a></p>
