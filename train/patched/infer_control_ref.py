...
GPU_memory_mode     = os.environ.get("GPU_MEMORY_MODE", "model_cpu_offload")
# Multi GPUs config
...
# model path
model_name          = os.environ.get("MODEL_NAME", "models/Diffusion_Transformer/Wan2.2-Fun-A14B-Control")
...
lora_path               = os.environ.get("LORA_LOW") or None
lora_high_path          = os.environ.get("LORA_HIGH") or None

# Other params
sample_size         = [int(x) for x in os.environ.get("SAMPLE_SIZE", "480,832").split(",")]
video_length        = 81
fps                 = 16
...
control_video           = os.environ["CONTROL_VIDEO"]
control_camera_txt      = None
start_image             = None
end_image               = None
ref_image               = os.environ.get("REF_IMAGE") or None
...
lora_weight             = float(os.environ.get("LORA_WEIGHT", "0.55"))
lora_high_weight        = float(os.environ.get("LORA_HIGH_WEIGHT", "0.55"))
save_path               = os.environ.get("SAVE_PATH", "samples/wan-control-demo")
